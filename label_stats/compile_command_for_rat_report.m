...
source_filename = ['write_rat_report_exec' v_string '.m'];
source_file = [source_dir source_filename]

include_string =[];
include_files = {'/home/rja20/cluster_code/workstation_code/analysis/vbm_pipe/label_stats/20130227_xlwrite/*'...
    '/cm/shared/apps/MATLAB/R2015b/toolbox/finance/calendar/month.m'...
    '/cm/shared/apps/MATLAB/R2015b/toolbox/finance/calendar/day.m'...
    '/cm/shared/apps/MATLAB/R2015b/toolbox/finance/calendar/year.m'};
...
for ff = 1:length(include_files)
    cp_cmd = ['cp -r ' include_files{ff} ' ' my_dir];
    system(cp_cmd);
end
