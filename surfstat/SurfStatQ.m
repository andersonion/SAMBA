...
msg_1 = 'We are implementing the resels filter';
msg_2 = 'No resels funny business happening here!';
if isfield(slm,'du')
...
%Debugging
qval.P=ones(1,size(mask,2));
qval.P(mask)=P_val;
%save_file = '/nas4/rja20/surfstat_debug_matlab_workspace.mat';
%save(save_file)
return
end
