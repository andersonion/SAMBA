...
if isnumeric(Y)
    ...
    rando = num2str(round(rand*1000000))% Added by BJA, 3 Jan 2017, to help avoid file collisions.
    filenameResid=fullfile(PATHSTR,['Resid_' rando '.mmm']); % '_{rando}' added per comment directly above.
