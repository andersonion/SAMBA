function [] = surfstat_for_vbm_pipeline(contrast,average_mask,inputs_directory,results_directory,group_1_name,group_2_name,group_1_filenames,group_2_filenames)
...
for direction = (0:1)
    ...
    h = sort(h);
    for i=1:length(h)
        saveas(h(i), [results_directory contrast 'figure_' num2str(i) suffix], 'fig');
    end
end
end
