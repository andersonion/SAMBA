...
### INTERNAL GLOBALS. Often set by init, sometimes by runtime(becuase they're set during runtime or main from other modules)
...
# ------------------
    ...
    ####
    # FOLLOWING WAS FORMLERY IN RUNTIME CHECK.
