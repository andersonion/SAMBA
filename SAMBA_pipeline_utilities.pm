   ...
   # 24 March 2023 (Fri) --BJA: Turning off this code, as file-checking is taking excruciatingly long on BIAC cluster for large studies.
    ...
    if (-d $inputs_dir) {
        ...
        if ((! defined $input_file) || ($input_file eq '') ) {
            my @input_files_1= grep(/^${runno}.*${test_contrast}\.($valid_formats_string)(\.gz)?$/i ,readdir(DIR)); #27 Dec 2016, added "^" because new phantom naming method of prepending (NOT substituting) "P" "Q" etc to beginning of runno results in ambiguous selection of files. Runno "S64944" might return "PS64944" "QS64944" or "S64944".
